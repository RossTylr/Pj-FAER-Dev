...
| Demo X-ray panels | [xray_panel.py:35](../demo_app/components/xray_panel.py#L35), [state_helpers.py:121](../demo_app/components/state_helpers.py#L121) | **SURFACE** | String-label references only — they name `"routing.py"`, they do not call it. Zero behavioural coupling. (A third site, `5_architecture.py`, was removed with that page.) |
